...
local SaveManager = {} do
    SaveManager.Folder = "IntellectualLibSettings/Config"
    ...
    function SaveManager:BuildConfigSection(tab)
        ...
        local section = tab:AddMiddleGroupbox("Configuration", 'save')
        ...
        local Loadconfig = section:AddButton({
            Text = 'Load config',
            Func = function()
        ...
        local Loadconfig2 = Loadconfig:AddButton({
        ...
        local DeleteButton2 = DeleteButton:AddButton({
            Text = 'Refresh List',
            Func = function()
              self.Library.Options.SaveManager_ConfigList:SetValues(self:RefreshConfigList())
            self.Library.Options.SaveManager_ConfigList:SetValue(nil)
        ...
        local Autoloadbutton2 = Autoloadbutton:AddButton({
            Text = 'Reset Autoload',
            Func = function()
